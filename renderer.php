...
class qtype_dermoscopysim_renderer extends qtype_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa, question_display_options $options) {
        ...
        $config = [
            ...
            'inputids' => $inputids,
            'strings' => [
                'announcecaptured' => get_string('announcecaptured', 'qtype_dermoscopysim'),
                'announcecleared' => get_string('announcecleared', 'qtype_dermoscopysim'),
                'announcepoints' => get_string('announcepoints', 'qtype_dermoscopysim'),
                'announceretake' => get_string('announceretake', 'qtype_dermoscopysim'),
                'clearpoints' => get_string('clearpoints', 'qtype_dermoscopysim'),
                'marginprompt' => get_string('marginprompt', 'qtype_dermoscopysim'),
                'marginregionlabel' => get_string('marginregionlabel', 'qtype_dermoscopysim'),
